...
import static com.intern.project1.constant.security.JWT.REQUEST_HEADER;
import static com.intern.project1.constant.uri.URI.AUTH_API;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (request.getServletPath().contains(AUTH_API)) {
